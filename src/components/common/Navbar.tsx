...
import logo from "../../../public/logo/Profi-Staff.png";
...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      style={{ backgroundColor: `rgba(23, 29, 39, ${opacity})` }}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20 relative">
          {/* Logo */}
          <Link href="/" className="font-bold flex items-center">
            <div className="relative w-[100px] h-[40px] sm:w-[120px] sm:h-[40px] md:w-[180px] md:h-[80px] lg:w-[180px] lg:h-[80px]">
              <Image
                src={logo}
                alt="Logo"
                fill
