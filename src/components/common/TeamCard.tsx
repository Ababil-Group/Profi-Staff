...
const TeamCard: FC<TeamCardProps> = ({
  ...
  return (
    <div
      ...
      <div className="mt-3 bg-primary-secondary duration-300 group-hover:bg-white rounded-lg py-2 px-4 text-base font-semibold">
        <a
          onClick={onClick}
          className="inline-flex text-primary duration-300 group-hover:text-primary cursor-pointer items-center gap-1 hover:underline">
          {btnText}
        </a>
      </div>
    </div>
